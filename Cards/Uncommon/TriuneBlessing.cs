...
namespace STS2_WineFox.Cards.Uncommon
{
        ...
        1, CardType.Power, CardRarity.Uncommon, TargetType.AllAllies)
    {
            ...
            CardPlay play)
        {
            ...
            if (consumed > 0m)
                await PowerCmd.Apply<ChantPower>(owner, -consumed, owner, this);
            ...
            {
                await PowerCmd.Apply<StrengthPower>(ally, strengthDexterity, owner, this);
                await PowerCmd.Apply<DexterityPower>(ally, strengthDexterity, owner, this);
                await PowerCmd.Apply<FocusPower>(ally, focus, owner, this);
            }
        }
