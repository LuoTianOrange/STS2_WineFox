...
namespace STS2_WineFox.Potions
{
    ...
    public sealed class ChorusFruit : SellableToMerchantPotionModel
    {
        ...
        public override PotionAssetProfile AssetProfile => Art(Const.Paths.ChorusFruit);
        ...
        protected override async Task OnUseInCombat(PlayerChoiceContext choiceContext, Creature? target)
        {
            ...
            await PowerCmd.Apply<BufferPower>(choiceContext, targetCreature, 1, Owner.Creature, cardSource: null);
        }
